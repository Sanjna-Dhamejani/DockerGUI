...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
      ...
      exes: {
        ...
        options: {
          ...
          "version-string": {
            ...
            LegalCopyright:
              "Copyright 2015-2016 Docker Inc. All rights reserved."
          }
        }
      }
    },
    ...
    copy: {
      dev: {
        files: [
          ...
          {
            src: "util/dockergui.icns",
            dest: "build/icon.icns"
          },
          {
            src: "util/dockergui.ico",
            dest: "build/icon.ico"
          },
          {
            src: "util/dockergui.png",
            dest: "build/icon.png"
          },
          {
            expand: true,
    ...
    shell: {
      ...
      zip: {
        command:
          "ditto -c -k --sequesterRsrc --keepParent <%= OSX_FILENAME_ESCAPED %> release/" +
          VERSION_FILENAME +
          "-Mac.zip"
      },
      linux_npm: {
  ...
  grunt.registerTask("release:debian:x32", [
    "release:linux",
    "electron-installer-debian:linux32",
    "compress:debian"
  ]);
  grunt.registerTask("release:debian:x64", [
    "release:linux",
    "electron-installer-debian:linux64",
    "compress:debian"
  ]);

  grunt.registerTask("release:redhat:x32", [
    "release:linux",
    "electron-installer-redhat:linux32"
  ]);
  grunt.registerTask("release:redhat:x64", [
    "release:linux",
    "electron-installer-redhat:linux64"
  ]);
